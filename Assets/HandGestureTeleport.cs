...
{
    /// <summary>
    /// Makes a GameObject follow a tracked hand or motion controller with logic for allowing teleportation when the user shows their palm in a spider man style.
    /// </summary>
    /// <remarks>
    ...
    public class HandGestureTeleport : MonoBehaviour
    {
        /// <summary>
